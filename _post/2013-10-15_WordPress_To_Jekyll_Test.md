...
1. Download XAMPP from [http://www.apachefriends.org/zh_cn/xampp.html][1]
2. Download the latest wordpress zip file from [http://wordpress.org/download/][2] 
...
1.  The exitwp tool convert the WP XML file to files which extention is `.markdown`, we need rename the file extention to `.md` by the following script.
    ren  *.*  *.md
2.  You may write some sripts to update the md files as you wish.
<br/>
<br/>
